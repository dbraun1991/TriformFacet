"""High-resolution render of the cel/toon-style icon — same composition
and camera as `render_icon_celshade.py`, just 8192x8192. See
...
render_icon_from_builder(
    HIGHRES_SIZE, RENDERS_DIR / "highres_celshade_icon.png", build_scene_celshade,
)
